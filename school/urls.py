...
from .views import (ClassRoomListView, ClassRoomDetailView,
                    ...
                    DeleteRestoreSubjectView, SessionListView, SessionCreateView
                    )
...
urlpatterns = [
    ...
    path("subjects-dashboard/", SubjectsListView.as_view(), name="subject_list"),
    ...
    path("session-dashboard/", SessionListView.as_view(), name="session_dashboard"),
